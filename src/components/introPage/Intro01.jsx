      ...
      <div className="font-Pretendard ">
        ...
        <div className="container mx-auto grid grid-cols-12 gap-4 max-w-screen-xl">
          <div className="col-span-12 md:col-span-6">
            {/* 첫번째 줄 내용 겹치는 박스 */}
            <div className="box md:absolute md:top-40 relative p-6 sm:p-3 md:p-5 mt-20">
            ...
            <div className="py-5 md:py-40 p-6 sm:p-3 text-base sm:text-lg">
              ...
              우리는 챗봇을 통해 이용자들의 요구사항을 확인합니다. <br />
              서비스에 필요한 정보들을 챗봇과 해결해보세요. <br />
              상권, 성별, 연령을 바탕으로 최적의 시선배치를 도와줍니다. <br />{" "}
