...
function MainPageAfter() {
  ...
  return (
    ...
    <div className="bg-gray-100 h-screen bg-no-repeat bg-cover md:bg-[url('https://i.ibb.co/Q8M7ycH/Kakao-Talk-20231018-121457122.png')] dark:bg-[url('https://i.ibb.co/PD92ZQZ/1.png')]">
      {/* 헤더 */}
