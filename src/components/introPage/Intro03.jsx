    ...
    return (
        <div className="font-Pretendard">
          ...
          />
                    ...
                    대형마트, 대기업 편의점 등과 같은 대형 업체들이 주로 받는 솔루션을 합리적인 가격에 이용할 수 있습니다 {/* 내용작성하셈 */}
                </div>
                <div className=' text-center md:text-left col-span-12 md:col-span-6'>
                <img
          ...
          />
                    ...
                    eyecon은 챗봇을 활용해 AI와 실시간으로 대화하며 이용자들이 타겟으로 하는 대상과 여러 정보들을 명확히 합니다.  {/* 내용작성하셈 */}
                </div>
                <div className='text-center md:text-left col-span-12 md:col-span-6'>
                <img
          ...
          />
                    ...
                    우리 서비스는 가게의 매대를 분석합니다. 제품의 매출에 큰 영향을 주는 매대를 분석해 고객의 시선을 예측하고 효과적인 솔루션을 제공합니다 {/* 내용작성하셈 */}
                </div>
            </div>
