  ...
  return (
    <div className="h-screen bg-no-repeat bg-cover md:bg-[url('https://i.ibb.co/Q8M7ycH/Kakao-Talk-20231018-121457122.png')] dark:bg-[src('./assets/servicemain.png').default]">
      ...
      <div className="flex flex-col items-center" style={{ height: "calc(100vh - 120px)" }}>
        ...
        {/* 내부박스 */}
        <div className={`w-[95%] md:w-[70%] md:h-[90%] p-3 rounded-2xl ${showMainPay ? '' : 'flex flex-col justify-center items-center'}`} style={{ background: "linear-gradient(179.97deg, #fff 0.05%, rgba(255,255,255,0) 99.98%)", boxShadow: "0px 4px 30px 0 rgba(190,190,190,0.47)" }}>
