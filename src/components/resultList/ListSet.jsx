    ...
    <div className="container font-Pretendard mx-auto grid grid-cols-12 max-w-screen-x">
      ...
      <div className='bg-white col-span-10 md:col-span-8 flex flex-col justify-center items-center rounded-[25px] border' style={{
        ...
        <div>
          ...
          <div className="col-span- grid gird-cols-36  md:col-span-4 group rounded-lg border border-[#d9d9d9] p-5  bg-[#FFFFFF] bg-opacity-10">
            <p className='text-2xl font-bold text-left text-black p-2'> 2023-10-30 </p>
            ...
            <div className='bg-white rounded-[20px]' style={{ boxShadow: "0px 4px 4px 0 rgba(0,0,0,0.25)" }}>
              ...
              <div className='col-span-6 md:col-span-4'>
                <div className='col-span-6 grid-cols-4'>
                  <p className='col-span-6 text-2xl font-bold text-left p-2'> 시선분석 전 </p>
                  <button className='col-span-6 md:col-span-4 border-[1.5px] border-[#19ab93] rounded-[20px] w-[116px] h-auto text-center'>
                    Download ↓
                  </button>
                </div>
