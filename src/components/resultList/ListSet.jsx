    ...
    <div className='grid grid-cols-12 gap-4'>
      ...
      <div className='col-span-4 p-4 text-center w-[auto] h-[auto]' style={{ filter: "drop-shadow(0px 4px 4px rgba(0,0,0,0.25)" }}>
        ...
        <div className=' w-[auto] h-[auto] rounded-[35px] bg-white' style={{ boxShadow: "1px 1px 1px 0 rgba(0,0,0,0.1", backgroundColor: "PALEGOLDENROD" }}>
          ...
          <div className='col-span-7 p-4 h-[auto] left-[200px] top-[190px] rounded-[20px] bg-[#15c3a7] text-center' style={{ boxShadow: "2px 6px 0 rgba(0,0,0,0.25)" }}>
            <p className='top-auto left-auto font-bold text-right text-neutral-100' style={{ width: 'auto', whiteSpace: 'nowrap', overflow: 'hidden' }}>A마트</p>
          </div>
