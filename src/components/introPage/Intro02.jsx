                    ...
                    <div className="flex flex-wrap -m-4 text-center">
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full ">
                            <div className="border-1 border-blue-300 px-4 py-8 rounded-lg transform transition duration-500 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-110 ">
                                ...
                                <h2 className="title-font font-medium text-3xl text-gray-900 dark:text-[#F2F2F2]">시선 분석 히트맵</h2>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-1 border-gray-300 px-4 py-8 rounded-lg transform transition duration-500 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-110">
                                ...
                                <h2 className="title-font font-medium text-3xl text-gray-900 dark:text-[#F2F2F2]">마케팅 솔루션</h2>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-1 border-gray-300 px-4 py-8 rounded-lg transform transition duration-500 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-110">
                                ...
                                <h2 className="title-font font-medium text-3xl text-gray-900 dark:text-[#F2F2F2]">이미지 다운로드</h2>
                        ...
                        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="border-1 border-gray-300 px-4 py-8 rounded-lg transform transition duration-500 hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-110">
                                ...
                                <h2 className="title-font font-medium text-3xl text-gray-900 dark:text-[#F2F2F2]">상권 분석 데이터</h2>
